...
class Init
{
    ...
    {
        $version = '1.0.0';
        $this->src_url = "http://cloud.zjhejiang.com/we7/video/install/{$version}/src.zip";
        $this->db_url = "http://cloud.zjhejiang.com/we7/video/install/{$version}/db.sql";
    ...
    public function run()
    {
        ...
        if ($_W['ispost']) {
            ...
            pdo_run(file_get_contents($this->db_file));
