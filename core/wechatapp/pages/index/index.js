...
Page({
    ...
    onHide: function () {
        ...
        page.video = wx.createVideoContext("video_" + index);
        page.video.seek(0);
        page.video.pause();
        page.video = null;
        page.setData({
    ...
    play_1: function (option) {
        var page = this;
        var index = page.data.hide;
        var old = wx.createVideoContext("video_" + index);
        old.seek(0);
        old.pause();
        old = null;
        ...
        var new_video = wx.createVideoContext("video_" + new_index);
    ...
    pause: function (e) {
        var page = this;
        var index = e.currentTarget.dataset.index;
        var video = wx.createVideoContext('video_' + index);
        video.pause();
        video = null;
        page.setData({
            hide: -1
    ...
    timeUpdate: function (e) {
        ...
        var play = wx.createVideoContext('video_' + index);
